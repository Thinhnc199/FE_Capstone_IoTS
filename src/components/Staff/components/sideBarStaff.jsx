...
const items2 = [
  ...
  },
  {
    ...
    children: [
      // {
      //   key: "la",
      //   label: <Link to="/staff/list-account">List Account</Link>,
      //   icon: <UnorderedListOutlined />,
      // },

      // {
      //   key: "manager",
      //   label: <Link to="/staff/manager-account">Manager Account</Link>,
      //   icon: <UnorderedListOutlined />,
      // },
      {
        key: "store",
        label: <Link to="/staff/store-account">Store Account</Link>,
        icon: <UnorderedListOutlined />,
      },
      {
        key: "trainer",
        label: <Link to="/staff/trainer-account">Trainer Account</Link>,
        icon: <UnorderedListOutlined />,
      },
      {
        key: "customer",
        label: <Link to="/staff/customer-account">Customer Account</Link>,
        icon: <UnorderedListOutlined />,
      },
    ],
  },
