...
//   // Get state from Redux with fallback
//   const paymentState = useSelector((state) => state.payment || {});
//   const { paymentUrl, paymentResult, wallet, loading: paymentLoading, error: paymentError } = paymentState;

//   const storeRegistrationState = useSelector((state) => state.storeRegistration || {});
...
//   // Initialize userId and fetch initial data
//   useEffect(() => {
//     const id = localStorage.getItem("userId");
//     if (id) {
//       setUserId(id);
...
//         returnUrl: "http://localhost:5173/payment-packages",
//       })
//     );
