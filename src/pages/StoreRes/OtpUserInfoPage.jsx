...
//     dispatch(registerStoreUser({ userInfo, otp, password: formData.password })).then((res) => {
...
//         <h2 className="text-2xl font-bold mb-4 text-center text-[#00a8e8]">Verify & Register</h2>

//         {/* Prefilled Email (Cannot Edit) */}
//         <Input value={userEmail || ""} disabled className="mb-4 bg-gray-200" />
...
//         <Input name="phone" placeholder="Phone" onChange={handleChange} className="mb-4" />
//         <Input name="address" placeholder="Address" onChange={handleChange} className="mb-4" />
//         <Input.Password name="password" placeholder="Password" onChange={handleChange} className="mb-4" />
//         <Input.Password name="confirmPassword" placeholder="Confirm Password" onChange={handleChange} className="mb-4" />

//         {/* Register Button */}
//         <Button type="primary" onClick={handleRegister} block disabled={loading}>
